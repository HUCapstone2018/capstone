    ...
    1: [
        function(e, t, n) {
            ...
            var i = e("./ImageLoaded.js"),
                r = {
                    create: function() {
                        this.element = document.createElement("img"), this.element.setAttribute("src", "") // <== (ORIGINALLY) this.element.setAttribute("src", this.src)
                    },
                    preload: function(e) {
        ...
        function(e, t, n) {
            ...
            var i = e("./PercentageParser"),
                r = {
                    ...
                    setStyling: function() {
                        this.element.style.width = "100%", this.element.style.marginTop = "0px", this.element.style.backgroundColor = this.barColor, this.element.style.position = "absolute", this.element.style.bottom = "0%", this.setTransitionTime(100)/*
                    ...
                    updateProgress: function(e, t) {
                        0 !== t && this.setTransitionTime(t), e = i(e), this.element.style.height = e + "%"
                    },
                    setTransitionTime: function(e) {
                        this.element.style.WebkitTransition = "height " + e + "ms", this.element.style.MozTransition = "height " + e + "ms", this.element.style.OTransition = "height " + e + "ms", this.element.style.MsTransition = "height " + e + "ms", this.element.style.Transition = "height " + e + "ms"
                    }
                };
            t.exports = function() {
            ...
            var i = e("./PercentageParser"),
                r = {
                    ...
                    applyStyling: function() {
                        this.element.style.position = "absolute", this.element.style.fontSize = "3em", this.element.style.bottom = "0%", this.element.style.left = "0", this.element.style.textAlign = "center", this.element.style.color = this.barColor, this.element.style.width = "100%", this.element.style.textAlign = "center", this.setTransitionTime(100), this.element.style.height = "51px";
                        /*this.element.style.height = "40px", this.element.style.width = "100%", this.element.style.position = "absolute", this.element.style.fontSize = "3em", this.element.style.top = "50%", this.element.style.left = "0", this.element.style.marginTop = "-" + (59 + this.barHeight) + "px", this.element.style.textAlign = "center", this.element.style.color = this.barColor*/
                    },
                    updateProgress: function(e, t) {
                        0 !== t && this.setTransitionTime(t), e = i(e), this.element.innerHTML = e + "%", this.element.style.bottom = e + "%";
                    },
                    setTransitionTime: function(e) {
                        this.element.style.WebkitTransition = "bottom " + e + "ms", this.element.style.MozTransition = "bottom " + e + "ms", this.element.style.OTransition = "bottom " + e + "ms", this.element.style.MsTransition = "bottom " + e + "ms", this.element.style.Transition = "bottom " + e + "ms"
                    }
                };
            t.exports = function() {
                var e = Object.create(r);
        ...
        function(e, t, n) {
            ...
            var i = e("./../ImagePreloader"),
                ...
                o = {
                    ...
                    destroy: function() {
                        this.overlay.remove(), this.options.onComplete(), window.setTimeout(function(){$("#qLtempOverlay").remove()}, 500)
                    }
                };
