 ...
 */
	...
	public function meta(){
		//Thomas Rader: Stolen directly from Fahad... :)
		//Amjo: hahahahah you fuckin Robin Hood, you
//debug($this->view->viewVars);
	    $metaForLayout = array();
 ...
 */
    public function beforeLayout($layoutFile) {
		...
		if($this->request->here == '/'){
			...
			if(
				isset($this->view->viewVars['node']['Seo']) && 
				isset($this->view->viewVars['node']['Seo']['meta_title']) && 
				!empty($this->view->viewVars['node']['Seo']['meta_title'])
			){ //overwrite inside pages' nodes with meta_title if there is one
				$this->view->set('title_for_layout', $this->view->viewVars['node']['Seo']['meta_title']);
			}elseif(
				isset($this->view->viewVars['title_for_layout']) && 
				!empty($this->view->viewVars['title_for_layout']) &&
				$this->request->params['controller'] != 'contacts'
			){ //handle the inside pages
				$this->view->set('title_for_layout', $this->view->viewVars['title_for_layout']. Configure::read('Site.title_for_pages'));
				$this->view->set('title_for_layout', $this->view->viewVars['title_for_layout']. Configure::read('Site.title_for_pages'));
				$this->view->set('title_for_layout', $this->view->viewVars['title_for_layout']. Configure::read('Site.title_for_pages'));

			}else {
				if($this->request->params['controller'] == 'contacts' && $this->request->params['action'] == 'view')
					$this->view->set('title_for_layout', $this->view->viewVars['title_for_layout']);
			}
